       ...
       <div class="p-0 container-fluid position-relative">
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container py-5 text-center" style="max-width: 900px;">
                <h4 class="mb-4 text-white display-4 wow fadeInDown" data-wow-delay="0.1s">Beneficiaries</h4>
                <ol class="mb-0 breadcrumb d-flex justify-content-center wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active text-primary">Beneficiaries</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                    <div>
                        <h4 class="text-primary">Need Support?</h4>
                        <h1 class="mb-4 display-5">We Are here To Help</h1>
                        ...
                        <div class="p-5 rounded bg-light h-100 wow fadeInUp" data-wow-delay="0.2s">
                            <h4 class="text-primary">Beneficiary Form</h4>
                            <p class="mb-4">Please fill the form with the correct and legit details.</p>
                            <form>
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            <input type="name" class="border-0 form-control" id="name" placeholder="Your Email">
                                    ...
                                    <div class="col-lg-12 col-xl-6">
                                        <div class="form-floating">
                                            <input type="email" class="border-0 form-control" id="email" placeholder="Email">
                                            <label for="email">Your Email</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="border-0 form-control" placeholder="Address Details" id="address" style="height: 160px"></textarea>
                                            <label for="address">Address</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="border-0 form-control" id="sutudentID" placeholder="STudent ID">
                                            <label for="studentID">Student ID*</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="file" class="border-0 form-control" id="sutudentID" placeholder="STudent ID">
                                            <label for="studentID">ID Upload</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button class="py-3 btn btn-primary w-100">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="overflow-hidden rounded bg-primary position-relative">
                        <img src="{{ asset('asset/img/p8.jpg') }} " class="rounded img-fluid w-100" alt="">
                        <div class="rounded-bottom">
                            <img src="{{ asset('asset/img/p9.jpg') }} " class="img-fluid rounded-bottom w-100" alt="">
                        </div>
                    </div>
                </div>
            </div>
