                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-12 col-md-6">
                                    <div>
                                        ...
                                        <textarea class="form-control" id="body" name="body" rows="12">{{ $event->body }}</textarea>
                                        @error('body')
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" id="event_date"
                                            value="{{ $event->event_date }}" name="event_date">
                                        @error('event_date')
                                            <span class="badge bg-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        @else
                                            <img id="showImage" class="rounded avatar-lg" src="{{ asset($event->image) }}"
                                                alt="IMAGE"
                                                style="width: 200px; border: 1px solid #000000;height:250px;">
                                        @endif
                                        <hr>
