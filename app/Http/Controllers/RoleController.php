...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.settings.roles.create', compact('permissions', 'permission_groups'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('systemsetting.roles.edit', compact('role', 'permissions', 'permission_groups'));
    }
